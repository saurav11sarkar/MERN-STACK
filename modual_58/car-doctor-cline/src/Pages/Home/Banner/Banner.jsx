  ...
  return (
    <div className="carousel w-fit h-[500px]">
      ...
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute rounded-xl left-0 top-0 h-full flex items-center justify-start bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
        ...
        <div className="absolute gap-4 right-5 bottom-0 flex -translate-y-1/2 transform  justify-end">
          <a href="#slide6" className="btn btn-circle btn-outline text-white">
            ❮
          </a>
      ...
      <div id="slide4" className="carousel-item relative w-full">
        ...
        <div className="absolute gap-4 right-5 bottom-0 flex -translate-y-1/2 transform  justify-end">
          ...
          <a href="#slide5" className="btn btn-circle btn-outline">
            ❯
          </a>
        </div>
      </div>
      <div id="slide5" className="carousel-item relative w-full">
        ...
        <div className="absolute gap-4 right-5 bottom-0 flex -translate-y-1/2 transform  justify-end">
          ...
          <a href="#slide6" className="btn btn-circle btn-outline">
            ❯
          </a>
        </div>
      </div>
